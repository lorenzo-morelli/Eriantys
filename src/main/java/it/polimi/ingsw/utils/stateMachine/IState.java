...
public interface IState {
     ...
     */
    IEvent entryAction(IEvent cause) throws Exception;

    /**
     *  As an interaction, unlike this method is called when the controller is "exiting" the state
     */
    void exitAction(IEvent cause) throws IOException;
}
