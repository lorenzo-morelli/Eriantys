...
/*
 * Questo e'un esempio di come funziona il controllore
 * Il controllore, tutti gli eventi e gli stati devono essere istanziati con un nome.
 * Questo aiuterà perché i nomi appariranno nel registro (log) ogni volta che si verificano cambiamenti di stato.
 *
 * La costruzione del controllore è una serie di chiamate "ControllerServer.addTransition".
 * che definiscono ogni possibile transizione.
 */
...
public class DemoEsempio {
    ...
    public DemoEsempio(JTextArea jTextArea) {
        // /////////////////// INSTANTIATE EVENTS
